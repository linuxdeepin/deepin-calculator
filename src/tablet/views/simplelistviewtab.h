...
#ifndef SIMPLELISTVIEWTAB_H
#define SIMPLELISTVIEWTAB_H
...
class SimpleListViewTab : public DListView
{
    Q_OBJECT

public:
    explicit SimpleListViewTab(int mode = 0, DWidget *parent = nullptr); //mode:0-标准模式 1-科学模式
    ~SimpleListViewTab();
