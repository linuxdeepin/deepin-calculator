...
EqualButtonTab::EqualButtonTab(const QString &text, QWidget *parent)
 ...
 * @param msec 100ms
 */
void EqualButtonTab::animate(bool isspace, int msec)
{
 ...
 * @brief 设置点击下的标置位
 */
void EqualButtonTab::mousePressEvent(QMouseEvent *e)
{
 ...
 * @brief 设置鼠标松开时的标志位
 */
void EqualButtonTab::mouseReleaseEvent(QMouseEvent *e)
{
    if (e->button() == Qt::RightButton)
        return;
...
void EqualButtonTab::enterEvent(QEvent *e)
{
...
void EqualButtonTab::leaveEvent(QEvent *e)
{
...
void EqualButtonTab::paintEvent(QPaintEvent *e)
{
    Q_UNUSED(e);
...
void EqualButtonTab::keyPressEvent(QKeyEvent *e)
{
    switch (e->key()) {
    case Qt::Key_Up:
        emit focus(0);
