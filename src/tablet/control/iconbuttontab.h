...
#ifndef IconButtonTab_H
#define IconButtonTab_H
...
class IconButtonTab : public TextButtonTab
{
    Q_OBJECT
...
public:
     ...
     * @param page 科学模式第二页的IconButtonTab
     */
    IconButtonTab(QWidget *parent = nullptr, int b = 0, bool page = false);
    ~IconButtonTab();
