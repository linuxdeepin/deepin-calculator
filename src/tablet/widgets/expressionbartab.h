...
#ifndef EXPRESSIONBARTAB_H
#define EXPRESSIONBARTAB_H
 ...
 * @brief 存放联动信息
 */
struct historicalLinkageIndexTab {
    int linkageTerm;
    int linkedItem;
    QString linkageValue;
    bool isLink;
    historicalLinkageIndexTab()
    {
        linkageTerm = -1;
        linkedItem = -1;
        isLink = false;
...
class ExpressionBarTab : public DWidget
{
    Q_OBJECT

public:
    ExpressionBarTab(QWidget *parent = nullptr);
    ~ExpressionBarTab();
...
private:
    ...
    QString m_selection;
    QVector<historicalLinkageIndexTab> m_hisLink;  //历史联动索引
